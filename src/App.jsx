...
function App() {
  ...
  const addNewRandomTweets = () => {
    const randomTweets = [
      "Acabei de entrar no clone do Twitter de Alexandre! Estou animado para me conectar com todos aqui. 👋 #NovoUsuário",
  ...
  return (
    <div className="flex mx-auto max-w-7xl">
      ...
      <main className="flex-grow border-l border-r border-gray-700 max-w-xl">
        ...
        <TwitterForm onTweet={(content) => addNewTweet(content, Math.random() > 0.7)}/>
        <div>
          {tweets.map(tweet => (
      ...
      <aside className="hidden xl:block w-80 px-4">
        <div className="sticky top-0 pt-2">
          ...
          <div className="bg-gray-800 rounded-xl mt-4 p-4">
            ...
            <TrendItem category='Sports • Trendings' name="Kyle Dugger" />
            <TrendItem category='Sports • Trendings' name="Anathony Richardson" tweetCount="13,8K" />
            <TrendItem category='Sports • Trendings' name="Bryce Young" tweetCount="5,436" />
            <TrendItem category='Sports • Trendings' name="Daboll" tweetCount="1,342" />
          </div>
          <div className="bg-gray-800 rounded-xl mt-4 p-4">
